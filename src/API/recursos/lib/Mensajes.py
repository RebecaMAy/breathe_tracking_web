#CAMPOS
mensaje_campo_email = 'El campo email es obligatorio'
mensaje_campo_token ='El campo token es obligatorio'

#ESTADOS DE HTTP
mensaje_error_correo = "El correo proporcionado no está registrado."
